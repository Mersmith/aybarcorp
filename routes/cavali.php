...
use App\Livewire\Cavali\EnviosCavali\EnviosCavaliTodoLivewire;
...
Route::prefix('envios-cavali')->name('envios-cavali.vista.')->group(function () {
    Route::get('/', EnviosCavaliTodoLivewire::class)->name('todo');
});
