...
<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        ...
        <div class="cabecera_titulo_botones">
            ...
            <a href="{{ route('admin.grupo-proyecto.vista.crear') }}" class="g_boton g_boton_primary">
                        ...
                        <tbody>
                            @foreach ($items as $index => $item)
                                <tr>
                                    ...
                                    <td class="g_resaltar">{{ $item->subtitulo }}</td>
                                    <td>
                                    ...
                                    <td class="centrar_iconos">
                                        <a href="{{ route('admin.grupo-proyecto.vista.editar', $item->id) }}"
