...
<div x-data="dataProyectoEditar" class="g_gap_pagina">
            ...
            <div class="g_columna_8 g_gap_pagina">
                ...
                <div class="g_panel">
                    ...
                    <div wire:ignore style="g_ckeditor">
                        ...
                        <textarea id="contenido" class="w-full form-control" rows="6" wire:ignore x-data x-init="ClassicEditor.create($refs.miEditorProyecto, {
                                toolbar: [
                                    'undo', 'redo', '|',
                                    'heading', '|',
                                    'bold', 'italic', '|',
                            ...
                            x-ref="miEditorProyecto">{!! $contenido !!}</textarea>
                ...
                <div class="g_panel">
                    ...
                    <table class="tabla_eliminar">
                        ...
                        <tbody x-sort="handleProyectoEditar">
    ...
    <script>
        ...
        function dataProyectoEditar() {
            return {
                handleProyectoEditar(item, position) {
                    Livewire.dispatch('handleProyectoEditarOn', {
                        item,
                        position
                    });
                },
