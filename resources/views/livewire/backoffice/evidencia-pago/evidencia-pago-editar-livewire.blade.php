                ...
                <div class="g_panel">
                    <h4 class="g_panel_titulo">Datos cliente
                        <span class="g_badge activo">
                            <a href="{{ route('admin.cliente.vista.editar', $solicitud->userCliente) }}" target="_blank"
                    ...
                    <div class="g_fila">
                        <div class="g_margin_bottom_10 g_columna_4">
                            <label>Cliente</label>
                            <input type="text" disabled value="{{ $solicitud->userCliente->name ?? 'Sin asignar' }}">
                        </div>
                        ...
                        <div class="g_margin_bottom_10 g_columna_4">
                            <label>Email</label>
                            <input type="text" disabled value="{{ $solicitud->userCliente->email ?? 'Sin asignar' }}">
                        </div>
                    </div>
                </div>
