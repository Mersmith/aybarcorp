@section('tituloPagina', 'Editar estado cita')

<div class="g_gap_pagina">
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Editar estado cita</h2>
        <div class="cabecera_titulo_botones">
            ...
            <a href="{{ route('admin.estado-cita.vista.todo') }}" class="g_boton g_boton_darkt">
    ...
    <div class="formulario">
        ...
        <div class="g_margin_top_20">
            <div class="formulario_botones">
                ...
                <a href="{{ route('admin.estado-cita.vista.todo') }}" class="cancelar">Cancelar</a>
            </div>
        </div>
    </div>

    <script>
        function alertaEliminarEstadoCita() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('eliminarEstadoCitaOn');
