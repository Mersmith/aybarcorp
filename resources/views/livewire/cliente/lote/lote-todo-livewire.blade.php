<div class="g_gap_pagina">
    ...
    <div class="g_panel">
        ...
        @livewire('cliente.estado-cuenta.estado-cuenta-ver-livewire', ['lote' => $lote_select, 'estado_cuenta' =>
        $estado_cuenta], key('estado-' . $lote_select['id_recaudo']))
    </div>
    @endif
    ...
    <div class="g_panel">
        ...
        @livewire('cliente.cronograma-estado-cuenta.cronograma-estado-cuenta-ver-livewire', ['lote' => $lote_select,
        'estado_cuenta' => $cronograma_estado_cuenta], key('cronograma-estado-' . $lote_select['id_recaudo']))
    </div>
    @endif
