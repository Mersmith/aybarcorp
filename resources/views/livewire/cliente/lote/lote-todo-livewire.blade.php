<div class="g_gap_pagina">
    ...
    <div class="g_panel">
        ...
        @livewire(
        'cliente.cronograma.cronograma-ver-livewire',
        ['lote' => $lote_select, 'cronograma' => $cronograma],
        key('cronograma-'.$lote_select['id_recaudo'])
        )
    </div>
    @endif
    ...
    <div class="g_panel">
        ...
        @livewire(
        'cliente.estado-cuenta.estado-cuenta-ver-livewire',
        ['lote' => $lote_select, 'estado_cuenta' => $estado_cuenta],
        key('estado-'.$lote_select['id_recaudo'])
        )
    </div>
    @endif
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="g_boton g_boton_empresa_primario"
                                wire:click="verCronograma({{ json_encode($lote) }})">
                                <i class="fas fa-calendar-alt"></i> Cronograma
                            </button>

                            <button class="g_boton g_boton_empresa_secundario"
                                wire:click="verEstadoCuenta({{ json_encode($lote) }})">
                                <i class="fas fa-calendar-alt"></i> Estado cuenta
                            </button>
                        </td>
                    </tr>
                    @endforeach
