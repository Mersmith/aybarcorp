...
<div class="g_gap_pagina">
    <div class="g_panel cabecera_titulo_pagina">
        ...
        <div class="cabecera_titulo_botones">
            ...
            <a href="{{ route('admin.permiso.vista.crear') }}" class="g_boton g_boton_primary">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="centrar_iconos">
                                <a href="{{ route('admin.permiso.vista.editar', $item) }}" class="g_accion_editar">
