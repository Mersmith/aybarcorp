    ...
    <div class="formulario">
        <div class="g_fila">
            ...
            <div class="g_columna_4 g_gap_pagina g_columna_invertir">
                ...
                <div class="g_panel">
                    <h4 class="g_panel_titulo">Ticket hijos</h4>
                ...
                @if (!$ticket->citas->isEmpty())
                <div class="g_panel">
                    <h4 class="g_panel_titulo">Citas programadas</h4>
                    ...
                    <table class="tabla_eliminar">
                        ...
                        <tbody>
                            @foreach ($ticket->citas as $cita)
                            <tr>
                                <td> {{ $cita->fecha_inicio}} </td>
                                <td> {{ $cita->gestor->name }} </td>
                                <td>
                                    <a href="{{ route('admin.cita.vista.editar', $cita->id) }}" class="g_accion_editar">
                                        <span><i class="fa-solid fa-pencil"></i></span>
                                    </a>
                                </td>
                            </tr>
    ...
    <script>
        ...
        function alertaEliminarArchivo(idArchivo) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('eliminarArchivoOn', {
                        id: idArchivo
                    });
